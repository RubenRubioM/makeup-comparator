...
mod product {
    ...
    fn WhenCreatingTones_ThenSuccess() {
        ...
        assert_eq!(name, tone.name());
        assert_eq!(price_standard, tone.price_standard());
        assert_eq!(price_sales.unwrap(), tone.price_sales().unwrap());
    }
    ...
    fn WhenCreatingAProduct_ThenSuccess() {
        ...
        assert_eq!(product.tones().unwrap().first().unwrap().price_standard(), price_standard);
        assert_eq!(product.tones().unwrap().first().unwrap().price_sales(), price_sales);
    }
